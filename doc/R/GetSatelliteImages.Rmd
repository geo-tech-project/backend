...
A function to get a UTM zone to a given longitude \
**parameters:** \
...
**topRightX** (Float) \
**topRightY** (Float) \
**returns:** (bbox) Creates an bbox object from the given bounding box coordinates
```{r getBBoxFromAOI}
...
**2** - Unexpected Error \
**3** - After filtering the results from stac_request with the cloud coverage no images where left \
